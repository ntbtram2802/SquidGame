...
public abstract class Entity {
    ...
    public void dyingAnimation(Graphics2D g2) {
    	actionLockCounter++;
    	int i = 5;
    	if (actionLockCounter <=i) {g2.drawImage(image11, x, y, GamePanel.tilesize, GamePanel.tilesize, null);changeAlpha(g2,1f);}
    	if (actionLockCounter >i && actionLockCounter <=i*2) {g2.drawImage(image11, x, y, GamePanel.tilesize, GamePanel.tilesize, null);changeAlpha(g2,0f);}
    	if (actionLockCounter >i*2 && actionLockCounter <=i*3) {g2.drawImage(image12, x, y, GamePanel.tilesize, GamePanel.tilesize, null);changeAlpha(g2,1f);}
    	if (actionLockCounter >i*3 && actionLockCounter <=i*4) {g2.drawImage(image12, x, y, GamePanel.tilesize, GamePanel.tilesize, null);changeAlpha(g2,0f);}
    	if (actionLockCounter >i*4 && actionLockCounter <=i*5) {g2.drawImage(image13, x, y, GamePanel.tilesize, GamePanel.tilesize, null);changeAlpha(g2,1f);}
       	if (actionLockCounter >i*5 && actionLockCounter <=i*6) {g2.drawImage(image13, x, y, GamePanel.tilesize, GamePanel.tilesize, null);changeAlpha(g2,0f);}
       	if (actionLockCounter >i*6 && actionLockCounter <=i*7) {g2.drawImage(image14, x, y, GamePanel.tilesize, GamePanel.tilesize, null);changeAlpha(g2,1f);}
       	if (actionLockCounter >i*7 && actionLockCounter <=i*8) {g2.drawImage(image14, x, y, GamePanel.tilesize, GamePanel.tilesize, null);changeAlpha(g2,0f);}
       	if (actionLockCounter >i*8 && actionLockCounter <=i*9) {g2.drawImage(image15, x, y, GamePanel.tilesize, GamePanel.tilesize, null);changeAlpha(g2,1f);}
       	if (actionLockCounter >i*9 && actionLockCounter <=i*10) {g2.drawImage(image15, x, y, GamePanel.tilesize, GamePanel.tilesize, null);changeAlpha(g2,0f);}
